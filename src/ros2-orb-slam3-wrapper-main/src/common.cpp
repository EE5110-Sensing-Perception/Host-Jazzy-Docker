...
MonocularMode::MonocularMode() :Node("mono_node_cpp")
{
    ...
    this->declare_parameter("enable_pangolin", true); // Enable/disable Pangolin window output
    this->declare_parameter("enable_opencv", true); // Enable/disable OpenCV window output  
    ...
    rclcpp::Parameter param4 = this->get_parameter("enable_pangolin");
    enablePangolinWindow = param4.as_bool();
    
    rclcpp::Parameter param5 = this->get_parameter("enable_opencv");
    enableOpenCVWindow = param5.as_bool();
    ...
    RCLCPP_INFO(this->get_logger(), "enable_pangolin: %s", enablePangolinWindow ? "true" : "false");
    RCLCPP_INFO(this->get_logger(), "enable_opencv: %s", enableOpenCVWindow ? "true" : "false");
...
void MonocularMode::initializeVSLAM(std::string& configString){
    ...
    // enablePangolinWindow and enableOpenCVWindow are set from ROS parameters in constructor
